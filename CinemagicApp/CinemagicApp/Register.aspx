<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="PLWebcinemagic.Register" %>
...
<body>
    <form id="form1" runat="server">  
        PLEASE REGISTER:<br />
         ...
         PASSWORD:  <asp:TextBox ID="txtPassword" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="ReqPassword" runat="server" ControlToValidate="txtPassword" ErrorMessage="Please enter a password." ></asp:RequiredFieldValidator><br />
         REPEAT PASSWORD:  <asp:TextBox ID="txtPassword2" runat="server"></asp:TextBox>
